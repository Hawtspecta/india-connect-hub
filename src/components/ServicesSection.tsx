...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="relative py-32 md:py-48 bg-gradient-section">
...
const ServiceCard = ({
  ...
  return (
    <motion.div
      ...
      className="group grid md:grid-cols-2 gap-8 md:gap-16 items-center py-16 border-t border-border first:border-t-0 hover:bg-card/30 transition-colors duration-500 px-4 md:px-8 -mx-4 md:-mx-8"
    >
